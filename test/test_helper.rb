...
class Test::Unit::TestCase #:nodoc:
  ...
  def create_fixtures(*table_names)
    if block_given?
      ActiveRecord::Fixtures.create_fixtures(Test::Unit::TestCase.fixture_path, table_names) { yield }
    else
      ActiveRecord::Fixtures.create_fixtures(Test::Unit::TestCase.fixture_path, table_names)
    end
  end
